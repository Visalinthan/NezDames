...
public class StructureAjouter extends javax.swing.JFrame {
    ...
    public StructureAjouter() {
        ...
        //cdxRepresentant.removeAllItems();
       // cdxContact.removeAllItems();
                                ...
                                if (txtMail.getText().compareTo("") == 0) {
                                    ...
                                    if (txtTel.getText().compareTo("") == 0) {
                                        ...
                                        for (PersonneStructure unePersonne : NezDamesSerialisation.lesPersonnes) {
                                            ...
                                            NezDamesSerialisation.lesStructures.add(new Structure(idMax + 1, Integer.parseInt(txtCodeNaf.getText()),
                                                    Integer.parseInt(txtNumero.getText()),txtNom.getText(), txtRue.getText(), txtVille.getText(), 
                                                    Integer.parseInt(txtCodePostal.getText()),txtMail.getText(), Integer.parseInt(txtTel.getText()), Responsable, Contact));
